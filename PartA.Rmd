...
This report examines and analyses the twitter language used by popular author and activist, J.K. Rowling, and twitter users who interact with or mention her.
...
After removing non-informative words we visualised the frequency of words in a word cloud.
```{r echo=FALSE}
