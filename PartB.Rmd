...
=======
```{r}
>>>>>>> 597a499bf72e2c76e41dcb06b913f601d1b29034
...
plot(simplify(graph),layout = layout.drl,vertex.size=log(retweetCount+1),
     edge.arrow.size=0.1,vertex.label.size=.5,vertex.label.color="black")
# to make the graph simpler we are taking the top 20 retweeted tweets.
...
##Findings
The most influential user 'culturalkumite' is a bot. The high influential ratio is as it has 61 followers and it follows only 1 user.This may be due due to the fact that it tweets about authors, film and art in general.People might be following the bot to get latest news in those fields. Other users of influential tweets do not have a very high influence ratio and are most likely fans of  J.K.Rowling's work.
