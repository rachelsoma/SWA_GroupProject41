...
plot(simplify(graph),layout = layout.drl, vertex.size=retweet.log*.9, vertex.label="",vertex.color=heat.colors(0),edge.width=0.5, edge.arrow.size=0)
...
There were some users who were accusing Rowling of Racism in the charecters she created, particularly for the 'nagini' role in the film Fantastic Beasts and other who think that Johnny Depp should not have been cast in Fantastic Beasts after being accused of assault by a former partner. On the other side of this is general excitement at the idea of actor Macauley Culkin being cast in the series.